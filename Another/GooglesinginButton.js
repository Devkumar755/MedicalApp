...
statusCodes,
 ...
 class GoogleCustomFile extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      userInfo: null,
  ...
  componentDidMount() {
    ...
    GoogleSignin.configure({
      ...
      webClientId: '871899051710-uoip62s3rbg7utode042r22jhrq2mk15.apps.googleusercontent.com',
    });
    ...
    if (this.state.gettingLoginStatus) {
      ...
      if (this.state.userInfo != null) {
        ...
        return (
            ...
            <Text style={{color:'white',fontSize:16,marginTop:15}}>Google SignIn</Text>
 ...
 export default withNavigation(GoogleCustomFile);
